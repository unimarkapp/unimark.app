  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2">
      ...
      <div className="bg-black dark:border-l hidden lg:flex items-center justify-center flex-col gap-4">
        <svg width="211" height="209" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <p className="text-muted-foreground max-w-md text-center">
          Unimark makes it easy to manage all of your bookmarks. Use our cloud or as a self-hosted
          and own your data.
        </p>
        <a
          target="_blank"
